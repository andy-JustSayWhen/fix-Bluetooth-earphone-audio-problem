...
7. [MAC-home01-MacBookAir：Bose 与 K03S 实测对照](05-MAC-home01-MacBookAir-Bose与K03S实测对照.md)
8. [K03S 蓝牙与 2.4G 接收器对照案例](cases/2026-07-16-K03S蓝牙与2.4G对照.md)
9. [采样率与声道听感对照案例](cases/2026-07-16-采样率与声道听感对照.md)
10. [选择蓝牙 A 作为输入导致蓝牙 B 进入 HFP](06-选择蓝牙A输入导致蓝牙B进入HFP.md)
11. [REDMI 跨设备蓝牙输入输出联动案例（macOS 15.7.7 / 24G720 / MACMINI9,1-175AC621）](cases/2026-07-17-REDMI跨设备蓝牙输入输出联动.md)
12. [跨设备蓝牙 HFP 降级的解决方案边界](07-跨设备蓝牙HFP降级的解决方案边界.md)
13. [跨设备 HFP 候选解决方案调研案例（macOS 15.7.7 / 24G720 / MACMINI9,1-175AC621）](cases/2026-07-17-跨设备HFP候选解决方案调研.md)
14. [HFP 与 A2DP 链路建立及恢复接口边界](08-HFP与A2DP链路建立及恢复接口边界.md)
15. [macOS 蓝牙与音频日志能力矩阵](09-macOS蓝牙与音频日志能力矩阵.md)
16. [2026-07-17 MAC-home02-MacMini 日志能力启用现场](cases/2026-07-17-MAC-home02日志启用现场.md)
17. [如何快速、完整地停用、恢复和监测 SoundSource](soundsource服务运维/00-SoundSource服务运维.md)
18. [2026-07-17 MAC-home02-MacMini SoundSource 服务运维实测](soundsource服务运维/cases/2026-07-17-MAC-home02-SoundSource服务运维实测.md)
19. [macOS 设备非预期进入 HFP 的原因与定位](10-macOS设备非预期进入HFP的原因与定位.md)
20. [2026-07-18 微信输入法探测蓝牙输入触发 HFP](cases/2026-07-18-微信输入法探测蓝牙输入触发HFP.md)
